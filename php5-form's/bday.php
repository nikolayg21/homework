...
<h1> Моля въведете данните си - дата , месец , година! </h1>
<form action="bday.php">
<div>
	<select name="day">
		<option value="go"> Дата </option>
